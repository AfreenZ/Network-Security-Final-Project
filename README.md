...
1a and 1b. Implementation of a Secure Key Exchange Application using the Diffie-Hellman algorithm 
...
3. Creating a digital signature demonstration so Users 1 and 2 can authenticate the identity of each other by implementing RSA
